...
TohyNet est un logiciel **propriétaire gratuit** (*freeware*). Il est distribué gratuitement mais **n'est pas open source**. Tous les droits, titres et intérêts relatifs au logiciel, y compris le code source, les interfaces et la documentation, restent la propriété exclusive de **TohyNet**.
...
TohyNet is **proprietary freeware**. It is distributed free of charge but is **not open source**. All rights, title, and interest in the software, including source code, interfaces, and documentation, remain the exclusive property of **TohyNet**.
...
*© 2026 TohyNet — Tous droits réservés / All rights reserved.*  
